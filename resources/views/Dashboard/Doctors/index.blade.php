    ...
    <div class="row row-sm">
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <!-- add or delete group of doctors -->
                <div class="card-header pb-0">
                    <a href="{{ route('Doctors.create') }}" class="btn btn-primary" role="button"
                        aria-pressed="true">{{ trans('doctors.add_doctor') }}
                    </a>

                    <button type="button" class="btn btn-danger" id="btn_delete_all">{{ trans('doctors.delete_select') }}
                    </button>
                </div>
