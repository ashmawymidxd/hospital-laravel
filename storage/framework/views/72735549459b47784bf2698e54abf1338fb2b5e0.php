    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('Dashboard/img/brand/logo.png')); ?>"
                                                              class="logo-1" alt="logo"></a>
                <a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('Dashboard/img/brand/logo-white.png')); ?>"
                                                              class="dark-logo-1" alt="logo"></a>
                <a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('Dashboard/img/brand/favicon.png')); ?>"
                           ...
                           aria-expanded="false">
                            <?php if(App::getLocale() == 'ar'): ?>
                                <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('Dashboard/img/flags/egypt_flag.jpg')); ?>" alt="img"></span>
                                <strong
                                    class="mr-2 ml-2 my-auto"><?php echo e(LaravelLocalization::getCurrentLocaleName()); ?></strong>
                            <?php else: ?>
                                <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                        src="<?php echo e(URL::asset('Dashboard/img/flags/us_flag.jpg')); ?>" alt="img"></span>
                                <strong
                                    class="mr-2 ml-2 my-auto"><?php echo e(LaravelLocalization::getCurrentLocaleName()); ?></strong>
                            <?php endif; ?>
                            <div class="my-auto">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  "
                                     data-image-src="<?php echo e(URL::asset('Dashboard/img/faces/3.jpg')); ?>">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('Dashboard/img/faces/2.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('Dashboard/img/faces/9.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('Dashboard/img/faces/12.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image"
                                     data-image-src="<?php echo e(URL::asset('Dashboard/img/faces/5.jpg')); ?>">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                                                                src="<?php echo e(URL::asset('Dashboard/img/faces/6.jpg')); ?>"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('Dashboard/img/faces/6.jpg')); ?>"
                                                                class=""></div>
                        ...
                        <?php if(auth('web')->check()): ?>
                            <form method="POST" action="<?php echo e(route('logout.user')); ?>">
                                <?php elseif(auth('admin')->check()): ?>
                                    <form method="POST" action="<?php echo e(route('logout.admin')); ?>">
                                        <?php elseif(auth('doctor')->check()): ?>
                                            <form method="POST" action="<?php echo e(route('logout.doctor')); ?>">
                                                <?php elseif(auth('ray_employee')->check()): ?>
                                                    <form method="POST" action="<?php echo e(route('logout.ray_employee')); ?>">
                                                        <?php elseif(auth('laboratorie_employee')->check()): ?>
                                                            <form method="POST"
                                                                  action="<?php echo e(route('logout.laboratorie_employee')); ?>">
                                                                <?php else: ?>
                                                                    <form method="POST"
                                                                          action="<?php echo e(route('logout.patient')); ?>">
                                                                        <?php endif; ?>
                                                                        <?php echo csrf_field(); ?>
...
<script>
    ...
    Echo.private('create-invoice.<?php echo e(auth()->user()->id); ?>').listen('.create-invoice', (data) => {
...
<!-- /main-header -->
<?php /**PATH C:\xampp\htdocs\hospital\resources\views/Dashboard/layouts/main-header.blade.php ENDPATH**/ ?>