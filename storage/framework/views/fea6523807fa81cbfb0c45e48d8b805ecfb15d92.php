<?php $__env->startSection('title'); ?>
    <?php echo e(trans('Dashboard/main-sidebar_trans.sections')); ?>
...
<?php $__env->startSection('page-header'); ?>
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"><?php echo e(trans('Dashboard/main-sidebar_trans.sections')); ?></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ <?php echo e(trans('Dashboard/main-sidebar_trans.view_all')); ?></span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">
                                            <?php echo e(trans('Dashboard/sections_trans.add_sections')); ?>
                                        ...
                                        <table class="table text-md-nowrap" id="example2">
                                           ...
                                           <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <tr>
                                                   ...
                                                   <td><a href="<?php echo e(route('Sections.show',$section->id)); ?>"><?php echo e($section->name); ?></a> </td>
...
<?php echo $__env->make('Dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hospital\resources\views/Dashboard/Sections/index.blade.php ENDPATH**/ ?>