    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(trans('Dashboard/sections_trans.edit_sections')); ?></h5>
            ...
            <form action="<?php echo e(route('Sections.update', 'test')); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <textarea type="text" name="description" class="form-control"><?php echo e($section->description); ?></textarea>
                </div>
...
<?php /**PATH C:\xampp\htdocs\hospital\resources\views/Dashboard/Sections/edit.blade.php ENDPATH**/ ?>